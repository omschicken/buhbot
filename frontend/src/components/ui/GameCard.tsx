...
export default function GameCard({ game, index }: { game: Game; index: number }) {
  ...
  return (
    ...
    >
      <div className="gcard-img" style={{ height: 90, background: '#202020', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 28, position: 'relative' }}>
        {game.emoji || '\u{1F3AE}'}
      ...
      <div style={{ padding: '7px 8px' }}>
        <div className="gcard-name" style={{ fontSize: 10, fontWeight: 600, color: '#ddd', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{game.name}</div>
