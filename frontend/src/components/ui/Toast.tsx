...
export default function ToastContainer() {
  ...
  return (
    <div className="toast-container" style={{ position: 'fixed', bottom: 80, right: 16, zIndex: 9999, display: 'flex', flexDirection: 'column', gap: 8 }}>
      <AnimatePresence>
        {toasts.map((t) => (
          <motion.div key={t.id}
            ...
            style={{
              ...
              padding: '12px 18px', color: '#fff', fontSize: 12, fontWeight: 600, cursor: 'pointer',
